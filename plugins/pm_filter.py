...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/movieplaza77")]])
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://t.me/movieplaza77")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
    ...
    # don't change anything without contacting me @creatorrio
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('CHANNEL', url=GRP_LNK ),
        ...
        buttons = [[
            InlineKeyboardButton('🫵 SUBSCRIBE 🫵', url="https://t.me/movieplaza77"),
        ],[
            InlineKeyboardButton('🍀 Movie Search Group 🍀', url="https://t.me/movieplaza77")
        ],[
            InlineKeyboardButton('🍂 Movie channel 🍂', url="https://t.me/movieplaza77")
        ],[
            InlineKeyboardButton('🍁 Bots Update Channel 🍁', url="https://t.me/movieplaza77")
        ],[
